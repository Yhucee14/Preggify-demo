...
const TopNavbar = () => {
  return (
    <nav className={`flex xs:flex-col sm:flex-row xx:flex-col bg-gradient-to-r from-green-800 to-green-600 width-full navbar text-primary ${styles.paddingX} ${styles.flexCenter} ${styles.paddingY}`}>
